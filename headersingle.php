                      ...
                      <li class="mb-15">
                          <div class="d-flex">
                              <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale">
                                  <a class="color-white" href="<?php echo $populararticledata[2]; ?>">
                                      <img src="../<?php echo $populararticledata[5]; ?>" alt="">
                                  </a>
                              </div>
                              <div class="post-content media-body">
                                  <h6 class="post-title mb-10 text-limit-2-row">  <a href="<?php echo $populararticledata[2]; ?>"><?php echo $populararticledata[1]; ?></a></h6>
