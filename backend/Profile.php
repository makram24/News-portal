                                      ...
                                      <div class="card-body">
                                          ...
                                          <form method="POST" action="edit-userdata.php?userid=<?php echo $userid ?>" class="" enctype="multipart/form-data">
                                            ...
                                            <div class="row col-md-12">
                                              <div class="form-group col-md-6">
                                                <label>Role</label>
                                                  <select class="custom-select" style="text-transform: capitalize;" name="roledata" id="roledata">
                                                    <option value=<?php echo $userdata[4]; ?> selected><?php echo $userdata[4]; ?></option>
                                                  </select>
                                              </div>
